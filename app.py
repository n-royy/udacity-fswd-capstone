...
def create_app(test_config=None):
  ...
  def update_movie(payload, id):
    ...
    if movie:
      movie.title = (new_info['title'] if new_info['title'] else movie.title)
  ...
  def update_actor(payload, id):
    ...
    if actor:
      actor.name = (new_info['name'] if new_info['name'] else Actor.name)
      actor.age = (new_info['age'] if new_info['age'] else actor.age)
      actor.gender = (new_info['gender'] if new_info['gender'] else actor.gender)
      actor.movie_id = (new_info['movie_id'] if new_info['movie_id'] else actor.movie_id)
      try:
        actor.update()
        return jsonify({
          'success': True,
